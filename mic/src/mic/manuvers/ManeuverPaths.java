...
public enum ManeuverPaths {
    ...
    Str1(StraightPaths.Str1, "Forward 1", 1, 0.0f, "524", 0.0f, 0.0f, 113.0f, 0.0f, 169.5f),
    Str2(StraightPaths.Str2, "Forward 2", 2, 0.0f, "525", 0.0f, 0.0f, 169.5f, 0.0f, 226.0f),
    Str3(StraightPaths.Str3, "Forward 3", 3, 0.0f, "526", 0.0f, 0.0f, 226.0f, 0.0f, 282.5f),
    Str4(StraightPaths.Str4, "Forward 4", 4, 0.0f, "527", 0.0f, 0.0f, 282.5f, 0.0f, 339.0f),
    Str5(StraightPaths.Str5, "Forward 5", 5, 0.0f, "528", 0.0f, 0.0f, 339.0f, 0.0f, 395.5f),

    K1(StraightPaths.Str1, "K-Turn 1", 1, 180.0f, "524", 0.0f, 0.0f, -113.0f, 0.0f, -169.5f),
    K2(StraightPaths.Str2, "K-Turn 2", 2, 180.0f, "525", 0.0f, 0.0f, -169.5f, 0.0f, -226.0f),
    K3(StraightPaths.Str3, "K-Turn 3", 3, 180.0f, "526", 0.0f, 0.0f, -226.0f, 0.0f, -282.5f),
    K4(StraightPaths.Str4 ,"K-Turn 4", 4, 180.0f, "527", 0.0f, 0.0f, -282.5f, 0.0f, -339.0f),
    K5(StraightPaths.Str5, "K-Turn 5", 5, 180.0f, "528", 0.0f, 0.0f, -339.0f, 0.0f, -395.5f),
