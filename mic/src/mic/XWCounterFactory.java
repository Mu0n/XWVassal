...
public class XWCounterFactory extends BasicCommandEncoder {
    ...
    static {
        ...
        GameModule.getGameModule().addCommandEncoder(AutoRangeFinder.AutorangeVisualizationEncoder.INSTANCE);
        GameModule.getGameModule().addCommandEncoder(new AutoRangeFinder.FOVisualizationClearEncoder());
    }
