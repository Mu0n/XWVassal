...
public class ShipReposition extends Decorator implements EditablePiece {
    ...
    public ShipReposition.CollisionVisualization previousCollisionVisualization = null;
    ...
    public ShipReposition(GamePiece piece) {
        ...
        previousCollisionVisualization = new ShipReposition.CollisionVisualization();
    }
