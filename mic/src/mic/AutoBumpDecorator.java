...
public class AutoBumpDecorator extends Decorator implements EditablePiece {
    ...
    private static Map<String, ManeuverPaths> moveCodeToManeuver = ImmutableMap.<String, ManeuverPaths>builder()
            .put("1F", ManeuverPaths.Str1)
            .put("2F", ManeuverPaths.Str2)
            .put("3F", ManeuverPaths.Str3)
            .put("4F", ManeuverPaths.Str4)
            .put("5F", ManeuverPaths.Str5)
            .put("1T", ManeuverPaths.LT1)
            .put("2T", ManeuverPaths.LT2)
            .put("3T", ManeuverPaths.LT3)
            .put("1Y", ManeuverPaths.RT1)
            .put("2Y", ManeuverPaths.RT2)
            .put("3Y", ManeuverPaths.RT3)
            .put("1B", ManeuverPaths.LBk1)
            .put("2B", ManeuverPaths.LBk2)
            .put("3B", ManeuverPaths.LBk3)
            .put("1N", ManeuverPaths.RBk1)
            .put("2N", ManeuverPaths.RBk2)
            .put("3N", ManeuverPaths.RBk3)
            .put("1K", ManeuverPaths.K1)
            .put("2K", ManeuverPaths.K2)
            .put("3K", ManeuverPaths.K3)
            .put("4K", ManeuverPaths.K4)
            .put("5K", ManeuverPaths.K5)
            .put("1A", ManeuverPaths.RevLbk1)
            .put("1S", ManeuverPaths.RevStr1)
            .put("2S", ManeuverPaths.RevStr2)
            .put("1D", ManeuverPaths.RevRbk1)
            .put("1L", ManeuverPaths.SloopL1)
            .put("2L", ManeuverPaths.SloopL2)
            .put("3L", ManeuverPaths.SloopL3)
            .put("1P", ManeuverPaths.SloopR1)
            .put("2P", ManeuverPaths.SloopR2)
            .put("3P", ManeuverPaths.SloopR3)
            .put("1E", ManeuverPaths.TrollL1)
            .put("2E", ManeuverPaths.TrollL2)
            .put("3E", ManeuverPaths.TrollL3)
            .put("1R", ManeuverPaths.TrollR1)
            .put("2R", ManeuverPaths.TrollR2)
            .put("3R", ManeuverPaths.TrollR3)
            .build();
